...
dataSH = np.loadtxt("out/Static/nonperiodic/nopenaltyMec/SG_energy_testshit delitee0.2_2.csv",delimiter="\t")
...
datauq = np.loadtxt("out/Static/nonperiodic/nopenaltyMec/errors_testshit delitee0.2_2.csv",delimiter="\t")
