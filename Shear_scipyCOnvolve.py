...
from PFCproc_TODO.ProcessPFC_nonP import *
...
geometry   = GeomParams(dx=pfcparms.a0/7,
                        ...
                        Nx=7*20,  # the domain size should the multiple of 7 (or 3.5) for periodicity of e^(iq.x)
...
filename  = "Shearscipy"+str(simparams.dt)+"_"+str(simparams.Cw)
path = "./out/shear/"
