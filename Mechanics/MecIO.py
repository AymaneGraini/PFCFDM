...
class MecIO:
    ...
    def write_output(self ,t:float):
        ...
        # self.file.write_function(self.mecComp.divalpha,t)
        # self.file.write_function(self.mecComp.divalphaQ,t)
        # self.file.write_function(self.mecComp.divalphaUe,t)
        # self.file.write_function(self.mecComp.divalphaUp,t)
        ...
        self.file.write_function(self.mecFe.UPpara,t)
        # self.file.write_function(self.mecFe.zp_old,t)
        # self.file.write_function(self.mecFe.zp_new,t)
        self.file.write_function(self.mecFe.UP,t)
        self.file.write_function(self.mecFe.U,t)
        ...
        self.file.write_function(self.mecComp.curlU,t)
        # self.file.write_function(self.mecComp.sumCurls,t)
